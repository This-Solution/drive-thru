package com.drivethru.service.constant;
...
public class RouteConstant {
    ...
    public static final String GET_LAST_ORDER_DETAILS = "/getLastAndMostPurchaseOrderDetails";
    public static final String CAMERA = "/cameraConfig";
