...
function Error404() {
  return (
    <>
      <Grid container spacing={12} direction='column' alignItems='center' justifyContent='center' sx={{ marginTop: 0, overflow: 'hidden' }}>
        <Grid item xs={12}>
          <Stack direction='row'>
            <Grid item>
              <Box sx={{ width: { xs: 250, sm: 590 }, height: { xs: 100, sm: 300 } }}>
