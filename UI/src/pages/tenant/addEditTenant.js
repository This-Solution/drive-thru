...
const validationSchema = Yup.object().shape({
  ...
  tenantName: Yup.string().required('Tenant Name is required.').max(100, 'Tenant Name must be at most 100 characters.'),
...
const AddEditTenant = ({ isOpen, handleClose, siteDetails, onSave }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      tenantName: siteDetails && siteDetails.tenantName ? siteDetails.tenantName : '',
      url: siteDetails && siteDetails.url ? siteDetails.url : '',
    },
            ...
            <Box sx={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>
              <DialogContent>
                <Grid container spacing={2} sx={{ flexDirection: { xs: 'column', sm: 'row' } }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Stack spacing={1}>
                      <InputLabel sx={{ marginBottom: 0.7 }}>Tenant Name</InputLabel>
                      <FormControl>
                        <TextField
                          fullWidth
                          id='tenantName'
                        ...
                        />
                        <FormHelperText error={Boolean(formik.touched.tenantName && formik.errors.tenantName)} sx={{ marginLeft: 0 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Stack spacing={1}>
                      <InputLabel sx={{ marginBottom: 0.7 }}>Url</InputLabel>
                      <FormControl>
                        <TextField
                          fullWidth
                          id='url'
                        ...
                        />
                        <FormHelperText error={Boolean(formik.touched.url && formik.errors.url)} sx={{ marginLeft: 0 }}>
