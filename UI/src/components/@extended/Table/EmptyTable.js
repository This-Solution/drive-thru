...
const StyledGridOverlay = styled(Stack)(({ theme }) => ({
    height: '550px',
    '& .ant-empty-img-1': {
        fill: theme.palette.mode === 'dark' ? theme.palette.secondary[200] : theme.palette.secondary[400]
    },
    '& .ant-empty-img-2': {
        fill: theme.palette.secondary.light
    },
    '& .ant-empty-img-3': {
        fill: theme.palette.mode === 'dark' ? theme.palette.secondary.A200 : theme.palette.secondary[200]
    },
    '& .ant-empty-img-4': {
        fill: theme.palette.mode === 'dark' ? theme.palette.secondary.A300 : theme.palette.secondary.A100
    },
    '& .ant-empty-img-5': {
        fillOpacity: 0.95,
        fill: theme.palette.secondary.light
